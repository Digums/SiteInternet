...
<h1 id="titrecondition">Conditions Générales d'Utilisation</h1>

<div id="conteneurcondition">

    <h2>ARTICLE 1 : Objet</h2>
    <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site DomIsep et leur utilisation par « l'Utilisateur ».<br>
        ...
        • DomIsep se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</p>
    <h2>ARTICLE 2 : Mentions légales</h2>
    <p>L'édition du site DomIsep est assurée par la Société At’hom au capital de 0 € dont le siège social est situé au 10 rue de Vanves ISSY-LES-MOULINEAUX 92130.<br>
        Le Directeur de la publication est Monsieur PINAULT Pierre-Ly.<br>
    ...
    <p>Le site permet à l'Utilisateur un accès gratuit aux services suivants :<br>
        •  [articles d’information] ;<br>
        •  [annonces classées] ;<br>
        •  [mise en relation de personnes] ;<br>
        •  [publication de commentaires / d’œuvres personnelles] ;<br>
        •  […].<br>
        ...
        Selon le cas :<br>
        L’Utilisateur non membre n'a pas accès aux services réservés aux membres. Pour cela, il doit s'identifier à l'aide de son identifiant et de son mot de <br>
        ...
        Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de [Nom du site].<br>
        ...
        L'Utilisateur a la possibilité de contacter le site par messagerie interne au site.</p>
    ...
    <p>Les informations demandées à l’inscription au site sont nécessaires et obligatoires pour la création du compte de l'Utilisateur. En particulier, l'adresse électronique pourra être utilisée par le site pour l'administration, la gestion et l'animation du service.<br>
        Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le site est déclaré à la CNIL sous le numéro 123456789.<br>
        ...
        •  par voie postale au 10 rue de Vanves ISSY-LES-MOULINEAUX.</p>
    ...
    <p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de DomIsep qui n'a pas le contrôle de ces liens.<br>
