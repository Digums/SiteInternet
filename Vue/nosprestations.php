...
<div id="groscadre">
    ...
    <div class="souscadre">
        <h2>Installation</h2>
        <p><img src="../Autre/images/installation.jpg" class="images" alt="template installateur" style="width: 200px; border: 3px solid #CFB294 ;"  />
    ...
    <div class="souscadre">
        <h2>Surveillance</h2>
        <p><img src="../Autre/images/surveillance.jpg" class="images" alt="template caméra" style="width: 200px; border: 3px solid #CFB294 ;" />
    ...
    <div class="souscadre">
        <h2>Suivi</h2>
        <p><img src="../Autre/images/suivi.jpg" class="images" alt="template téléphone" style="width: 200px; border: 3px solid #CFB294" />
